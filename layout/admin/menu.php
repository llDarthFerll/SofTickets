...
<!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-info elevation-4">
    ...
    <a href="<?php echo $URL;?>/principal.php" class="brand-link">
      <img src="<?php echo $URL;?>/public/imagenes/Logo.jpg" alt="" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-gotham-light">SofTickets</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo $URL;?>/public/imagenes/Fercho.jpg" class="img-circle elevation-2" alt="">
        </div>
        <div class="info">
