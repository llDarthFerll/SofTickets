                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Rutas libres </h3>
                            ...
                            <div class="card-body" style="display: block;">
                                <div class="row">
                                    ...
                                    foreach($mapeos as $mapeo){
                                        $id_map = $mapeo['id_map'];
                                        $nro_vehiculos = $mapeo['nro_vehiculos'];
                                        $estado_ruta = $mapeo['estado_ruta'];

                                        if($estado_ruta == "LIBRE"){ ?>
                                            <div class="col">
                                                <center>
                                                    <h2><?php echo $nro_vehiculos;?></h2>

                                                    <button class="btn btn-success" style="width: 100%;height: 114px"
                                                            data-toggle="modal" data-target="#modal<?php echo $id_map;?>">
                                                        <p><?php echo $estado_ruta;?></p>
                                                    </button>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" id="cuviculo<?php echo $id_map;?>" value="<?php echo $nro_vehiculos; ?>">
                                                                        </div>
                                                                    </div>
                                        ...
                                        if($estado_ruta == "OCUPADO"){ ?>
                                            <div class="col">
                                                <center>
                                                    <h2><?php echo $nro_vehiculos;?></h2>
                                                    <button class="btn btn-info" id="btn_ocupado<?php echo $id_map;?>" data-toggle="modal"
                                                            data-target="#exampleModal<?php echo $id_map;?>">
                                                        <img src="<?php echo $URL;?>/public/imagenes/minibus.png" width="px" alt="">
                                                    </button>

                                                    <?php

                                                    $query_datos_cliente = $pdo->prepare("SELECT * FROM tb_tickets WHERE cuviculo = '$nro_vehiculos' AND estado = '1' ");
